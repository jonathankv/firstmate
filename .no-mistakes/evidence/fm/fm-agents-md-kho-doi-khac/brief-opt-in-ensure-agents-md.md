...
If `AGENTS.md` or `CLAUDE.md` already exists, or if this task produced durable project-intrinsic knowledge, run `/Users/jonathanvu/.no-mistakes/worktrees/38c446864270/01M1C7WEEVXSKQEYC0CFBTD0Q6/bin/fm-ensure-agents-md.sh .` in the worktree.
Record only project knowledge useful to almost every future session.
For anything the codebase already shows, prefer a pointer to the authoritative file, command, or doc over copying the detail.
If you touch a project `AGENTS.md` that lacks `## Maintaining this file`, add that short self-governance section from `/Users/jonathanvu/.no-mistakes/worktrees/38c446864270/01M1C7WEEVXSKQEYC0CFBTD0Q6/bin/fm-ensure-agents-md.sh` in the same pass.
